...
esc_html__( '[ Horseclub ] Recent Post', 'horseclub-companion' ), 

// Widget description
array( 'description' => esc_html__( 'Add recent post with thumbnail', 'horseclub-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Recent Post', 'horseclub-companion' );
}
//	
...
?>
<p>
<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:' ,'horseclub-companion'); ?></label> 
<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
</p>
<p>
<label for="<?php echo $this->get_field_id( 'post_number' ); ?>"><?php _e( 'Posts Number:' ,'horseclub-companion'); ?></label> 
