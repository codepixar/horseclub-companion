...
if ( !class_exists( 'Horseclub_El_Widgets' ) ) {
    ...
    final class Horseclub_El_Widgets {
        ...
        public function __clone() {
            ...
            _doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'horseclub-companion' ), '1.7.0' );
        }
        ...
        public function admin_notice_missing_main_plugin() {
            ...
            /* translators: 1: Elementor */
                esc_html__( '"%1$s" requires "%2$s" to be installed and activated.', 'horseclub-companion' ),
                '<strong>' . esc_html__( 'Horseclub Theme', 'horseclub-companion' ) . '</strong>',
                '<strong>' . esc_html__( 'Elementor', 'horseclub-companion' ) . '</strong>'
            );
        ...
        public function admin_notice_minimum_elementor_version() {
            ...
            /* translators: 1: Elementor 2: Required Elementor version */
                esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'horseclub-companion' ),
                '<strong>' . esc_html__( 'Horseclub', 'horseclub-companion' ) . '</strong>',
                '<strong>' . esc_html__( 'Elementor', 'horseclub-companion' ) . '</strong>',
        ...
        public function admin_notice_minimum_php_version() {
            ...
            /* translators: 1: PHP 2: Required PHP version */
                esc_html__( '"%1$s" requires "%2$s" version %3$s or greater.', 'horseclub-companion' ),
                '<strong>' . esc_html__( 'Horseclub', 'horseclub-companion' ) . '</strong>',
                '<strong>' . esc_html__( 'PHP', 'horseclub-companion' ) . '</strong>',
        ...
        public function add_elementor_category() {
            ...
            \Elementor\Plugin::instance()->elements_manager->add_category( 'horseclub-elements', [
                'title' => __( 'Horseclub Elements', 'horseclub-companion' ),
            ], 1 );
        ...
        public function enqueue_element_widgets_scripts() {
            ...
            ******************/
            ...
            wp_register_script( 'horseclub-map-custom', plugins_url( 'assets/js/map-custom.js', __FILE__ ), array('jquery'), '1.0', true );
            ...
            wp_enqueue_script( 'horseclub-companion', plugins_url( 'assets/js/horseclub-companion-main.js', __FILE__ ), array( 'jquery', 'jquery-ui-datepicker' ), '1.0', true );
        ...
        public function register_widget_styles() {
            // Typing Effect
            wp_enqueue_style( 'horseclub-companion-elementor-edit', plugins_url( '/assets/css/elementor-edit.css', __FILE__ ) );
        }
