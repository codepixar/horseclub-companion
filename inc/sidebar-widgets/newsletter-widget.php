...
esc_html__( '[ Horseclub ] Newsletter Form', 'horseclub-companion' ), 

// Widget description
array( 'description' => esc_html__( 'Add footer newsletter signup form.', 'horseclub-companion' ), ) 
);
...
<div id="mc_embed_signup" class="horseclub-subscribe-newsletter newsletter-form">
	<form target="_blank" novalidate action="<?php echo esc_url( $actionurl ); ?>" id="mc-embedded-subscribe-form" method="post" class="navbar-form">
		...
		<input type="email" name="EMAIL" class="form-control" placeholder="<?php esc_html_e( 'Email address', 'horseclub-companion' ); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email address'" required>
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Newsletter', 'horseclub-companion' );
}
...
<p>
<label for="<?php echo esc_attr( $this->get_field_id( 'actionurl' ) ); ?>"><?php esc_html_e( 'Action URL:' ,'horseclub-companion'); ?></label> 
