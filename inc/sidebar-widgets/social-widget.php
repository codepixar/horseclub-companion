...
esc_html__( '[ Horseclub ] Social Widget', 'horseclub-companion' ),

// Widget description
array( 'description' => esc_html__( 'Add social content', 'horseclub-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Follow Us', 'horseclub-companion' );
}
